...
export const authService = {
   ...
   * 检查手机号是否已注册
   */
  checkPhone: async (phone: string): Promise<ApiResponse<{ exists: boolean; message: string }>> => {
   ...
   * 检查身份证号是否已注册
   */
  checkIdNumber: async (idNumber: string): Promise<ApiResponse<{ exists: boolean; message: string }>> => {
